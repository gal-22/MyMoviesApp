...
public class FindMoviesFragment extends Fragment implements FindMoviesContract.View{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FindMoviesPresenter findMoviesPresenter = new FindMoviesPresenter(FindMoviesFragment.this, getContext());
        // Inflate the layout for this fragment
        return inflater.inflate(R.layout.fragment_find_movies, container, false);
    }
